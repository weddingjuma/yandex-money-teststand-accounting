...
#pragma warning disable 1998
        private async void OnLoading(FrameworkElement sender, object args)
        {
            ...
            m_noiseBrush.Surface = await SurfaceLoader.LoadFromUri(new Uri("ms-appx:///Resources/Images/Noise.jpg"));
        ...
        private CompositionEffectBrush BuildBlurBrush()
        {
            ...
            BlendEffect blendEffect = new BlendEffect
            {
                ...
                Foreground = new ColorSourceEffect { Name = "Color", Color = Color.FromArgb(0, 255, 255, 255) },
