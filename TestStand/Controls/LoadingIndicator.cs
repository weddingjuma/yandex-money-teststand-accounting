...
{
    /// <summary>
    /// Контрол, позволяющий отображать индикацию загрузки.
    /// Content на время загрузки скрывается. Умеет отображать текст ошибки (например если не удалось что-то загрузить) через свойство Error.
    /// </summary>
